...
<div x-data="{editMode: false}" class="max-w-md mx-auto p-6 flex flex-col gap-3">
    ...
    @foreach ($this->wallets as $wallet)
        <div class=" flex items-center">
            <a wire:navigate href="{{ route('transaction.form.new', $wallet) }}" style="background-color: {{ $wallet->color }}"
                ...
                <div class="font-normal text-xs">
                    ...
                    <div class=" text-2xl font-extrabold">{{ number_format($wallet->totalRemaining,$this->selectedCountry->decimal_points) }} <span
